...
#include "pistonDisplacementPointPatchVectorField.H"
...
pistonDisplacementPointPatchVectorField::
pistonDisplacementPointPatchVectorField
(
    const pointPatch& p,
...
pistonDisplacementPointPatchVectorField
(
    const pistonDisplacementPointPatchVectorField& ptf,
    const pointPatch& p,
    const DimensionedField<vector, pointMesh>& iF,
...
void pistonDisplacementPointPatchVectorField::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
void pistonDisplacementPointPatchVectorField::write(Ostream& os) const
{
