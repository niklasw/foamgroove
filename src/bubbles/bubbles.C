...
namespace Foam
{
    defineTemplateTypeNameAndDebug(Cloud<bubbles>, 0);
}

// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool Foam::bubbles::move
(
    trackingData& td,
...
void Foam::bubbles::hitProcessorPatch
(
...
void Foam::bubbles::hitWallPatch
(
...
void Foam::bubbles::transformProperties (const tensor& T)
{
...
void Foam::bubbles::transformProperties(const vector& separation)
{
    particle::transformProperties(separation);
}


Foam::scalar Foam::bubbles::wallImpactDistance(const vector&) const
{
    return 0.5*d_;
}
