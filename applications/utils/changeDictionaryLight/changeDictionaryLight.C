...
Description
    See changeDictionary description. This application is an attempt
    to get the same functionality, without the need to create the mesh.

    Will go on to implement this as an option to standard changeDictionary.

Usage

    - changeDictionaryLight [OPTION]
...
int main(int argc, char *argv[])
{
    ...
    {
        Info<< "Not interpreting any keys in the changeDictionaryLight"
            << " as patchGroups"
            << endl;
    }
